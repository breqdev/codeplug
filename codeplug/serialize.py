...
def serialize(channels: list[Channel]) -> str:
    ...
    for i, channel in enumerate(channels):
        ...
        writer.writerow({
            ...
            "Tone": tone,
            "rToneFreq": channel.tone.tx if channel.tone else 88.5,
            "cToneFreq": channel.tone.rx if channel.tone else 88.5,
            "DtcsCode": channel.dtcs.tx if channel.dtcs else 23,
            "DtcsPolarity": channel.dtcs.polarity if channel.dtcs else "NN",
            "RxDtcsCode": channel.dtcs.rx if channel.dtcs else 23,
