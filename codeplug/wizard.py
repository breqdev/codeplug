...
questions = [
    ...
    inquirer.List(
        "weather",
        "Would you like to include weather radio? (NOAA Weather Alert and Weatheradio)",
        ["Yes", "No"],
    ),
    inquirer.List(
        "gmrs",
        "Would you like to include GMRS channels?",
        ["All", "Simplex", "Repeaters", "None"],
    ),
    ...
    inquirer.List(
        "marine",
        "Would you like to include Marine VHF channels?",
        ["Yes", "Most Common", "No"],
    ),
    inquirer.Path(
        "output",
        message="Where would you like to save the codeplug CSV?",
...
options = BuildOptions(
    ...
    marine=(
        "yes"
        if answers["marine"] == "Yes"
        else "starred"
        if answers["marine"] == "Most Common"
        else "no"
    ),
)
...
with open(answers["output"], "w") as file:
